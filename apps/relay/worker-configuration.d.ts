/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 083f7ab9db7014387fc7dab9d555d8bf)
// Runtime types generated with workerd@1.20260617.1 2025-10-11 nodejs_compat
interface __BaseEnv_Env {
	OBJECTS: R2Bucket;
	DB: D1Database;
	EVENT_QUEUE: Queue;
	ENVIRONMENT: "production";
	WORKSPACE_SESSIONS: DurableObjectNamespace<import("./src/index").WorkspaceSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WorkspaceSession";
	}
